...
def get_document_by_id(doc_id):
    from python_rag.modules.documents.repo import get_document_by_id as repo_get_document_by_id
...
def list_documents(status=None, limit=DEFAULT_LIST_READY_DOCUMENTS_LIMIT):
    from python_rag.modules.documents.repo import list_documents as repo_list_documents
