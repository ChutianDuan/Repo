from python_rag.app.infra.redis_client import get_redis_client
from python_rag.app.core.error_codes import ERR_DB_ERROR
...
def create_user(name: str):
    try:
        ...
        raise AppError(ERR_DB_ERROR, f"Create user failed: {e}")
...
def get_latest_users(limit: int = 5):
    try:
        ...
        raise AppError(ERR_DB_ERROR, f"Query latest users failed: {e}")
